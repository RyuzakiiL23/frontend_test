    ...
    <main className=" mocha bg-surface0">
      ...
      <div className='mocha flex flex-wrap relative w-[1060px] m-auto gap-4 place-items-center mt-20 mb-20'>
        {data.map((item: any): any => (
          <div onClick={() => window.location.href = `/teacher/${item.id}`}  className='flex cursor-pointer flex-col relative w-[32%] h-[528px] border border-base rounded-3xl items-center bg-overlay2 shadow-2xl shadow-indigo-500/50'>
