...
<section className="grid grid-cols-2 px-20 gap-5 max-lg:grid-cols-1 max-lg:px-8 max-sm:px-0 mb-20">
  <div className="bg-back border border-gray-300 rounded-sm">
    <div className="px-5 pt-5 pb-2 flex flex-col gap-[4px]">
      ...
      <p className="text-second text-justify">
        A passionate front-end developer seeking to learn how to building websites and web applications.
      </p>
    </div>
  ...
  <div className="bg-back border border-gray-300 rounded-sm">
    <div className="px-5 pt-5 pb-2 flex flex-col gap-[4px]">
      ...
      <p className="text-second text-justify">
        A passionate back-end developer with smooth experience with Python, Flask and MySQL.
      </p>
    </div>
    <div className="flex justify-center items-center px-5 pb-3 pt-[7px]">
      <div className="flex gap-1">
        <a href="https://twitter.com/AhraAhlame" target="_blank" className="bg-twitter2 bg-no-repeat bg-contain h-10 w-10 hover:opacity-90">
          {/* Image removed */}
        </a>
